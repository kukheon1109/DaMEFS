...
class GroupDropBox : ThemeContainerControl
{
    ...
    public override void PaintHook()
    {
        ...
        if (_Checked == true)
        {
            ...
            LinearGradientBrush graBrush = new LinearGradientBrush(rect, Color.FromArgb(255, 255, 255), Color.FromArgb(244, 245, 247), LinearGradientMode.Vertical);
            G.FillRectangle(graBrush, rect);
...
class GroupPanelBox : ThemeContainerControl
{
    ...
    public override void PaintHook()
    {
        ...
        G.SmoothingMode = SmoothingMode.AntiAlias;
        G.Clear(Color.FromArgb(255, 255, 255));
        Rectangle rect = new Rectangle(0, 0, Width, 28);
        LinearGradientBrush graBrush = new LinearGradientBrush(rect, Color.FromArgb(255, 255, 255), Color.FromArgb(244, 245, 247), LinearGradientMode.Vertical);
        G.FillRectangle(graBrush, rect);
        G.DrawLine(new Pen(Color.FromArgb(233, 238, 240)), 1, 1, Width - 2, 1);
        G.DrawRectangle(new Pen(Color.FromArgb(171, 173, 179)), 0, 0, Width - 1, Height - 1);
        G.DrawRectangle(new Pen(Color.FromArgb(171, 173, 179)), 0, 0, Width - 1, 30);
        G.DrawString(Text, Font, new SolidBrush(this.ForeColor), 7, 6);
    }
}
