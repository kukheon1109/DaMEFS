...
class ChromeCheckbox : ThemeControl154
{
    ...
    protected override void PaintHook()
    {
        ...
        {
            case MouseState.None:
                LGB = new LinearGradientBrush(new Rectangle(0, 0, 12, 12), GTN, GBN, 90f);
                break;
            case MouseState.Over:
                LGB = new LinearGradientBrush(new Rectangle(0, 0, 12, 12), GTO, GBO, 90f);
                break;
            default:
                LGB = new LinearGradientBrush(new Rectangle(0, 0, 12, 12), GTD, GBD, 90f);
                break;
        }
        GraphicsPath buttonpath = CreateRound(Rectangle.Round(LGB.Rectangle), 4);
        G.FillPath(LGB, CreateRound(Rectangle.Round(LGB.Rectangle), 3));
        G.SetClip(buttonpath);
        LGB = new LinearGradientBrush(new Rectangle(0, 0, 12, 5), Color.FromArgb(150, Color.White), Color.Transparent, 90f);
        G.FillRectangle(LGB, Rectangle.Round(LGB.Rectangle));
        G.ResetClip();
        G.DrawPath(new Pen(Bo), buttonpath);
        ...
        if (Checked)
        {
            ...
            G.DrawImage(check, new Rectangle(1, 2, check.Width, check.Height));
        }
    }
...
class ChromeRadioButton : ThemeControl154
{
    ...
    protected override void PaintHook()
    {
        ...
        if (_Checked)
        {
            ...
            G.FillEllipse(LGB, new Rectangle(new Point(0, 0), new Size(12, 12)));
        }
        else
        {
            LinearGradientBrush LGB = new LinearGradientBrush(new Rectangle(new Point(0, 0), new Size(12, 14)), G1, G2, 90f);
            G.FillEllipse(LGB, new Rectangle(new Point(0, 0), new Size(12, 12)));
        }
        ...
        if (State == MouseState.Over & X < 13)
        {
            ...
            G.FillEllipse(SB, new Rectangle(new Point(0, 0), new Size(12, 12)));
        }
        else if (State == MouseState.Down & X < 13)
        {
        ...
        P.AddEllipse(new Rectangle(0, 0, 12, 12));
        G.SetClip(P);

        LinearGradientBrush LLGGBB = new LinearGradientBrush(new Rectangle(0, 0, 12, 4), Color.FromArgb(150, Color.White), Color.Transparent, 90f);
        G.FillRectangle(LLGGBB, LLGGBB.Rectangle);

        G.ResetClip();

        G.DrawEllipse(new Pen(Bo), new Rectangle(new Point(0, 0), new Size(12, 12)));

        if (_Checked)
        {
            SolidBrush LGB = new SolidBrush(Bb);
            G.FillEllipse(LGB, new Rectangle(new Point(3, 3), new Size(6, 6)));
        }
